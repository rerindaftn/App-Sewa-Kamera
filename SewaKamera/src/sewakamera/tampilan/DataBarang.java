...
public class DataBarang extends javax.swing.JFrame implements Metode{
    ...
    public final void autonumber(){
        try {
            ...
            String an = "SELECT MAX(id_kamera) FROM tbl_barang";
            st = conn.prepareStatement(an);
            rs = st.executeQuery(an);
            if(rs.next()){
                int a = rs.getInt(1);
                txt_idkamera.setText(Integer.toString(a+1));
            }
            rs.close();
            st.close();
    ...
    public final void makeTable(){
        Object[]judul={
            ...
            "ID","JENIS KAMERA","LENSA","MEMORI","JENIS AKSESORIS","HARGA SEWA"
        };
    ...
    public void insertData(){
        try {
            //Menulis SQL INSERT ke tabel tbl_barang
            String sql = "INSERT INTO tbl_barang VALUES"
                    + "('"+txt_idkamera.getText()
                    +"','"+txt_jenisKamera.getText()
                    +"','"+txt_lensa.getText()
                    +"','"+txt_memori.getText()
                    +"','"+txt_jenisAksesoris.getText()
                    +"','"+txt_hargaSewa.getText()+"')";
    ...
    public void updateData(){
        try {
            conn=(Connection)DatabaseKoneksi.koneksi();
            st = conn.createStatement();
            //Masukkan SQL UPDATE untuk tabel tbl_barang sesuai id_kamera yang dipilih
            st.executeUpdate("UPDATE tbl_barang set " 
                + "jenis_kamera='"+ txt_jenisKamera.getText() + "', "
                + "lensa='"+ txt_lensa.getText()+ "', "
                + "memori='"+ txt_memori.getText()+ "', "
                + "jenis_aksesoris='"+ txt_jenisAksesoris.getText()+ "', "
                + "harga_sewa='"+ txt_hargaSewa.getText()+ "'"
                + "where id_kamera= '"+txt_idkamera.getText()+ "'");
            //Memanggil method showData(String where)
    ...
    public void deleteData(){
        try {
            ...
            if ((jawab = JOptionPane.showConfirmDialog(null, "Apakah Anda Ingin Menghapus Data?", "Konfirmasi", JOptionPane.YES_NO_OPTION)) == 0) {
                conn=(Connection)DatabaseKoneksi.koneksi();
                st = conn.createStatement();
                //Menulis SQL DELETE untuk tabel tbl_barang sesuai id_user yang dipilih
                st.executeUpdate("DELETE FROM tbl_barang WHERE id_kamera='"
                    + tabModel.getValueAt(tbl_barang.getSelectedRow(), 0) + "'");
                //Memanggil method showData(String where)
   ...
   @Override
    ...
    public void cariAction(){
        try {
            ...
            if(txt_kategori.getSelectedItem().equals("ID")){
               sql="SELECT * FROM tbl_barang where id_kamera='"+txt_cari.getText()+"'";
            }else if(txt_kategori.getSelectedItem().equals("JENIS KAMERA")){
               sql="SELECT * FROM tbl_barang where jenis_kamera like'%"+txt_cari.getText()+"%'";
            }
    ...
    public void userClicked(){
        ...
        txt_idkamera.setText(tbl_barang.getValueAt(tbl_barang.getSelectedRow(), 0).toString());
        txt_jenisKamera.setText(tbl_barang.getValueAt(tbl_barang.getSelectedRow(), 1).toString());
        txt_lensa.setText(tbl_barang.getValueAt(tbl_barang.getSelectedRow(), 2).toString());
        txt_memori.setText(tbl_barang.getValueAt(tbl_barang.getSelectedRow(), 3).toString());
        txt_jenisAksesoris.setText(tbl_barang.getValueAt(tbl_barang.getSelectedRow(), 4).toString());
        txt_hargaSewa.setText(tbl_barang.getValueAt(tbl_barang.getSelectedRow(), 5).toString());
    }
    ...
    private void initComponents() {
        ...
        txt_idkamera = new javax.swing.JTextField();
        ...
        txt_idkamera.setBackground(new java.awt.Color(240, 228, 216));
        ...
        txt_jenisKamera.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_jenisKameraActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGroup(jPanel3Layout.createSequentialGroup()
                                    ...
                                    .addGap(50, 50, 50)
                                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(txt_jenisKamera, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(txt_idkamera, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addComponent(jLabel2)
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                                    .addGap(88, 88, 88)
                                    .addComponent(txt_lensa, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(txt_idkamera, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel7)
        ...
        txt_idkamera.setEditable(false);
        ...
        tbl_barang.setBackground(new java.awt.Color(235, 207, 196));
        ...
        txt_kategori.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-Pilih Kategori-", "ID", "JENIS KAMERA" }));
    ...
    private void txt_jenisKameraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_jenisKameraActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_jenisKameraActionPerformed
    ...
    private javax.swing.JTextField txt_idkamera;
