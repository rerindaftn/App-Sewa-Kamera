...
public class Pegawai_LaporanDataPenyewaan extends javax.swing.JFrame implements Laporan{
     ...
     */
    public Pegawai_LaporanDataPenyewaan() {
        initComponents();
    ...
    public final void makeTable(){
        Object[]judul={
            ...
            "JENIS AKSESORIS","TANGGAL SEWA","LAMA SEWA","TOTAL BAYAR"
        };
    ...
    public final void showData(String where){
        try {
            ...
            rs = st.executeQuery("SELECT tbl_transaksi.id_transaksi, tbl_penyewa.nama_penyewa, "
                    ...
                    + "tbl_barang.jenis_aksesoris, tbl_transaksi.tgl_sewa, "
                    ...
                    + "WHERE tbl_transaksi.status='Disewa'" + where);
            while(rs.next()){
                Object[]data={
        ...
        try {
           ...
           if(txt_kategori.getSelectedItem().equals("ID Transaksi")){
               sql="SELECT tbl_transaksi.id_transaksi, tbl_penyewa.nama_penyewa, "
                    ...
                    + "tbl_barang.id_kamera=tbl_transaksi.id_kamera) ON "
                    + "tbl_transaksi.id_penyewa=tbl_penyewa.id_penyewa "
                    + "WHERE tbl_transaksi.status='Disewa' AND "
    ...
    private void initComponents() {
        ...
        jLabel8.setText("LAPORAN DATA PENYEWAAN");
        ...
        txt_kategori.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-Pilih Kategori-", "ID Transaksi", "Nama Penyewa", "Tanggal Sewa" }));
        ...
        tbl_transaksi.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Transaksi", "Nama Penyewa", "Jenis Kamera", "Lensa", "Memori", "Jenis Aksesoris", "Tanggal Sewa", "Lama Sewa", "Total Bayar"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.String.class, java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.Integer.class
            };
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pegawai_LaporanDataPenyewaan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pegawai_LaporanDataPenyewaan().setVisible(true);
            }
        });
    }
