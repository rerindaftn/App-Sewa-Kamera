...
public class Pegawai_LaporanDataBarang extends javax.swing.JFrame implements Laporan{
     ...
     */
    public Pegawai_LaporanDataBarang() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("LAPORAN DATA BARANG");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pegawai_LaporanDataBarang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pegawai_LaporanDataBarang().setVisible(true);
            }
        });
    }
