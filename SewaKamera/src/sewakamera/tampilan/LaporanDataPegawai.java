...
public class LaporanDataPegawai extends javax.swing.JFrame implements Laporan{
    User usr = new User();
    public Statement st;
    public ResultSet rs;
    ...
    private void initComponents() {
        ...
        jLabel8.setText("LAPORAN DATA PEGAWAI");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LaporanDataPegawai().setVisible(true);
            }
        });
    }
