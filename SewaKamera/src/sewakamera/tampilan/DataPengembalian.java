...
public class DataPengembalian extends javax.swing.JFrame implements FormPenyewaan{
    ...
    public void clearData(){
        ...
        txt_status.setSelectedItem("-Pilih Status-");
        txt_total.setText("");
    }
    ...
    public final void makeTable(){
        Object[]judul={
            "ID TRANSAKSI","ID PENYEWA","ID BARANG","TANGGAL SEWA","TANGGAL KEMBALI",
    ...
    public void updateData(){
        try {
            ...
            st.executeUpdate("UPDATE tbl_transaksi set " 
                ...
                + "tgl_kembali='"+ txt_tglKembali.getText()+ "', "
                +"lama_sewa='"+txt_lamaSewa.getText() + "', "
                + "status='"+ txt_status.getSelectedItem()+ "', "
   ...
   @Override
    ...
    public void userClicked(){
        ...
        txt_tglKembali.setText(tbl_transaksi.getValueAt(tbl_transaksi.getSelectedRow(), 4).toString());
        txt_lamaSewa.setText(tbl_transaksi.getValueAt(tbl_transaksi.getSelectedRow(), 5).toString());
        txt_status.setSelectedItem(tbl_transaksi.getValueAt(tbl_transaksi.getSelectedRow(), 6).toString());
        txt_total.setText(tbl_transaksi.getValueAt(tbl_transaksi.getSelectedRow(), 7).toString());
    }
    ...
    private void initComponents() {
        ...
        txt_tglKembali.setBackground(new java.awt.Color(240, 228, 216));

        txt_status.setBackground(new java.awt.Color(240, 228, 216));
        txt_status.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-Pilih Status-", "Disewa", "Dikembalikan" }));
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(txt_tglSewa, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(txt_tglKembali, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(28, 28, 28)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(txt_memori, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txt_total, javax.swing.GroupLayout.DEFAULT_SIZE, 126, Short.MAX_VALUE)
        ...
        txt_tglSewa.setEditable(false);
        txt_lamaSewa.setEditable(false);
        ...
        tbl_transaksi.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Transaksi", "ID Penyewa", "ID Barang", "Tanggal Sewa", "Tanggal Kembali", "Lama Sewa", "Status", "Total Bayar"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.String.class, java.lang.Integer.class
            };
