...
public class Pegawai_DataPenyewa extends javax.swing.JFrame implements Metode{
   ...
   @Override
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pegawai_DataPenyewa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pegawai_DataPenyewa().setVisible(true);
            }
        });
    }
