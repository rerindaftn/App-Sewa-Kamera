...
public class Admin_LaporanDataBarang extends javax.swing.JFrame implements Laporan{
     ...
     */
    public Admin_LaporanDataBarang() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_LaporanDataBarang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_LaporanDataBarang().setVisible(true);
            }
        });
    }
