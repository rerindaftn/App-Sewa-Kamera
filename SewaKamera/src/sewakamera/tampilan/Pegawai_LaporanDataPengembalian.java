...
public class Pegawai_LaporanDataPengembalian extends javax.swing.JFrame implements Laporan{
     ...
     */
    public Pegawai_LaporanDataPengembalian() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pegawai_LaporanDataPengembalian.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pegawai_LaporanDataPengembalian().setVisible(true);
            }
        });
    }
