...
public class Admin_LaporanDataPenyewaan extends javax.swing.JFrame implements Laporan{
     ...
     */
    public Admin_LaporanDataPenyewaan() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_LaporanDataPenyewaan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_LaporanDataPenyewaan().setVisible(true);
            }
        });
    }
